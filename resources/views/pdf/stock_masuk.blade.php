        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 10%; text-align: center;">Jumlah Dipesan</th>
                    <th style="width: 10%; text-align: center;">Jumlah Diterima</th>
        ...
        @if($history->count() > 0)
            ...
            <div class="summary">
                <div class="summary-row">
                    Total Barang Masuk: <span style="color: #27ae60;">{{ $totalJumlah }}</span> unit
                </div>
                <div class="summary-row">
