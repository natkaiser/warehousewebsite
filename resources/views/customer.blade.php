    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-2">
                ...
                <h3 class="text-lg font-bold text-slate-800 tracking-tight">Cari Customer</h3>
            </div>
        ...
        <form action="{{ route('customer.index') }}" method="GET" class="flex gap-3">
            <div class="flex-1">
                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari berdasarkan nama customer, alamat, atau telepon..."
...
<div id="editModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
        ...
        <form id="editForm" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-400 mb-1 uppercase tracking-wider">Nama Customer</label>
...
<div id="deleteModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-sm">
        ...
        <h3 class="text-lg font-bold text-center text-slate-800 mb-2">Hapus Customer?</h3>
        <p class="text-center text-gray-600 text-sm mb-6">
            Apakah Anda yakin ingin menghapus customer <span id="deleteName" class="font-semibold text-slate-800"></span>? Tindakan ini tidak dapat dibatalkan.
        </p>
